        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-6">
                    <div class="block-16">
                        <figure>
                            <img src="{{ Voyager::image(setting('sobre.comeco_imagem')) }}" alt="Image placeholder" class="img-fluid rounded">
                ...
                <div class="col-md-5">
                    ...
                    <div class="site-section-heading pt-3 mb-4">
                        <h2 class="text-black">Como nós começamos</h2>
                    </div>
                    {!! setting('sobre.comeco') !!}
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="block-38 text-center">
                        <div class="block-38-img">
                            <div class="block-38-header">
                                ...
                                <h3 class="block-38-heading h4">Allyne Moura F. Moriningo</h3>
                                <p class="block-38-subheading">Fundadora</p>
                            </div>
                    ...
                    <div class="block-38 text-center">
                        <div class="block-38-img">
                            <div class="block-38-header">
                                ...
                                <h3 class="block-38-heading h4">Felipe G. Braiani S.</h3>
