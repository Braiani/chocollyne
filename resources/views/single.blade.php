			...
			<div class="col-md-6">
				...
				<div class="mb-5">
					<div class="input-group mb-3" style="max-width: 120px;">
						...
						<input type="text" class="form-control text-center" value="1" placeholder="" aria-label="Example text with button addon"
				...
				<p><a href="{{ route('cart') }}" class="buy-now btn btn-sm btn-primary">Adicionar ao carrinho</a></p>
